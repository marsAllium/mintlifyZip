...
| action\*                       | varchar     | A label indicating the primary intention of the transaction, from the perspective of the wallet that created the transaction. See [Supported labels](/realtime/supported-blockchains/polygon/raw/transactions#supported-labels)for the possible labels. | dex\_swap                                                                                |
